    ...
    return (
        <div>
            {/* {console.log(district_id)} */}
            {
                !searchClicked ?
                (
                <Grid style={{height:'100vh', width:'100vw', backgroundColor:"#001E6C", backgroundRepeat: "no-repeat",
                ...
                <Select
                    ...
                    style={{width:"50vw", border:'1px solid white'}}
                />
                <br/>
                <span style=
                {{color:"white"}}>Select age</span>
                <RadioGroup aria-label="quiz" name="quiz" onChange={handleRadioChange}>
                <FormControlLabel style=
                {{color:"white"}} value="18" control={<Radio />} label="18+" />
                <FormControlLabel style=
                {{color:"white"}} value="45" control={<Radio />} label="45+" />
                </RadioGroup>
